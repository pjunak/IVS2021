...
namespace XUnitTests
{
	...
	* Táto Tøída testuje správnost výpoètu tøídy ComputeClass, každá metóda
	* @brief Tøída, která obsabuje testy k tøíde, která vyèísly výraz v postfixové notaci (ComputeClass)
	*/
